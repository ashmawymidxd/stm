...
<li><a href="#contact.php"><img src="IMG/licence.png" class="icon"/></a><a m="1" href="#shopingcar.php">licence</a></li>
    ...
    <div id="contain">
       ...
       <center>
          <div class="guiadd">
            <form action="updatec.php" method='post' enctype="multipart/form-data" class="form">
            <div class="head">
            ...
            <p>product management system </p>
                ...
                <input type="text" placeholder="course level" name="clevel" value=" <?php echo($data['level'])?>"><br>
                <input type="text" placeholder="course depart" name="cdepart" value="<?php echo($data['department'])?>"><br>
                <button name="update" style="width:45%;background" class="uploade">update</button><br>
                <a href="carshop.php" class="display">display all courses</a>
            </form>
        </div>
